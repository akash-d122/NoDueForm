...
<head>
    ...
    <title>MITS | Faculty Details</title>
    <style>
        body {
            font-family: Poppins;
        }
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>MITS | Staff Information</title>
    ...
    <table style="width: 100%;">
        ...
        <form method="post">
            <div class="search-container" style="margin-bottom: 20px;">
                <label for="search">Faculty Name</label>
                <input type="text" id="search" name="search" autocomplete="on" placeholder="Enter Faculty Name here" style="padding: 5px; width: 380px; font-family: Poppins;">
                <button type="button" class="clear-btn" onclick="clearTable()">Clear</button>
                <button type="button" class="clear-btn" onclick="window.close()">Close</button>
            </div>
        </form>
