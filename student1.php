...
<body>
    <div class="content">
        ...
        <form method="POST" action="">
            <label for="roll_number" style="margin-top:0.6vh; font-size:1vw;">Roll Number : </label>
    ...
    <div style="margin-left : 2vw;">
        ...
        <div class="form-row">
            <div>
                ...
                <input type="text" style="width: 175px; margin-left: 20px; border: none; font-weight: bold; color: black;" value="<?php echo htmlspecialchars($student_data['name']); ?>" disabled>
            </div>
            <div>
        ...
        <div class="table-container">
            ...
            <div class="footer-row" style="font-size: 14px; text-align: center; height: 24px; margin-top: 30px; background-color: #f1f1f1; color: #333; padding: 5px; margin-right:2.5vw;">
